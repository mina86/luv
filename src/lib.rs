...
fn xyz_from_luv(luv: &Luv) -> [f32; 3] {
    ...
    let a = 0.75 * u_prime / v_prime; /* 3/4 * u' * v' */
    let x = y * 3.0 * a;
    let z = y * (3.0 / v_prime - a - 5.0);
...
mod tests {
    ...
    static CASES: Cases = Cases {
        ...
        xyz: [
            [0.5181152, 0.36154357, 0.2829195],
            [0.08752622, 0.045130707, 0.0041027875],
            [0.07589042, 0.15178084, 0.025296856],
            [0.038297836, 0.015319134, 0.20170192],
            [0.11418825, 0.16709997, 0.22699869],
            [0.1258241, 0.060449857, 0.2058047],
            [0.41241077, 0.21264932, 0.019331636],
            [0.35758457, 0.71516913, 0.11919508],
            [0.18045376, 0.072181515, 0.95038974],
            [0.5380384, 0.7873506, 1.0695846],
            [0.59286475, 0.28483093, 0.96972156],
            [0.7699955, 0.92781854, 0.1385265],
            [0.0, 0.0, 0.0],
            [0.048729002, 0.051269446, 0.055828184],
            [0.20171452, 0.21223073, 0.2311017],
